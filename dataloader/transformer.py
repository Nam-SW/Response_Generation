...
def load(
    ...
    def _split_decoder_data(sample):
        ...
        sample["labels"] = sample["decoder_input"] + tokenizer.eos_token
        sample["decoder_input"] = tokenizer.bos_token + sample["decoder_input"]
        return sample
    ...
    def _tokenize_function(sample):
        ...
        tokenized["decoder_input_ids"] = d["input_ids"]
        tokenized["decoder_padding_mask"] = e["attention_mask"]
