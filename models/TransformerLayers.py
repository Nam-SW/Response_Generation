...
class EncoderLayer(tf.keras.layers.Layer):
    def __init__(self, hidden_size, num_heads, rate=0.1, pre_ln=True):
        ...
        self.ffnn = FFNN(hidden_size, hidden_size * 4, "relu", rate)
